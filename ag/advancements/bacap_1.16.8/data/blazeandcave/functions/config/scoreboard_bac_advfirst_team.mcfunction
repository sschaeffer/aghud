...
tellraw @s ["",{"text":"[ »» ]","color":"green","clickEvent":{"action":"run_command","value":"/scoreboard objectives setdisplay below_name bac_advfirst_team"}}," ",{"translate":"Below each player's name"}]
